          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  if (signUpController.userType == "Kullanici") ...[
                    Text(
                      "Doğum Tarihi",
                      style: GoogleFonts.poppins(
                        fontSize: 18,
                    ...
                    TextField(
                      onChanged: (value) {
                        signUpController.setDateYear(value);
                      },
                      onSubmitted: (value) {
                        signUpController.setDateYear(value);
                      },
                  ...
                  ]  else if (signUpController.userType == "Yonetici") ...[
                    Text(
                      "Doğum Tarihi",
                      style: GoogleFonts.poppins(
                        fontSize: 18,
                  ...
                  MyButton(
                    onPressed: () {
                      if (signUpController.userType == 'Kullanici' &&
                              signUpController.imageFile != null &&
                              signUpController.dateYear != null ||
                          signUpController.userType == 'Yonetici' &&
                              signUpController.imageFile != null &&
                              signUpController.dateYear != null ) {
                        Navigator.push(
                            context,
